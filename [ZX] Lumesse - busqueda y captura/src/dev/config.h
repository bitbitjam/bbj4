...
#define SCR_FIN                 23      // Last screen. 99 = deactivated.
...
#define PLAYER_MIN_KILLABLE     2       // Only kill enemies with id >= PLAYER_MIN_KILLABLE
...
#define PLAYER_VY_INICIAL_SALTO 312      // Initial junp velocity (64/64 = 1 píxel/frame)
...
unsigned char comportamiento_tiles [] = {
	0, 8, 8, 0, 0, 0, 0, 8, 0, 0, 8, 8, 8, 1, 24,10,
