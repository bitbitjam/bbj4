...
//SKY MODS
//#define COMPRESS_SCREENS              // If defined you used an rcs format for title, ending...
#define COMPRESSED_MAPS                 // If defined you have an awesome decompresor :D
#define DMAP_BUFFER   0x5b01            // buffer ($5df2)
#define DMAP_BITSYMB  4                 // data from tmxcompress
#define DMAP_BITHALF  1                 // data from tmxcompress
#define SCR_W 15                        // data from tmxcompress
#define SCR_H 10                        // data from tmxcompress
...
#define PLAYER_VY_INICIAL_SALTO 220		// Initial junp velocity (64/64 = 1 píxel/frame)
#define PLAYER_MAX_VY_SALTANDO	230	// Max jump velocity (320/64 = 5 píxels/frame)
...
unsigned char comportamiento_tiles [] = {
	0, 8, 8, 8, 8, 1, 8, 0, 4, 0, 0, 8, 8, 10,10,10,
	0, 2, 0, 1, 0, 0, 0, 8, 8, 8, 0, 0, 0, 0, 0, 0,
