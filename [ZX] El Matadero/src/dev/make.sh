...
tmxcompress ../map/mapa.tmx build/mapa_comprimido.bin


echo "---------------------------"
echo "### POSTERIZE GFX ###"

posterizezx ../gfx/work.png build/work.png
posterizezx ../gfx/font.png build/font.png
posterizezx ../gfx/sprites.png build/sprites.png


echo "---------------------------"
echo "### POSTERIZE PANTALLAS ###"
...
gfxcnv build/font.png build/work.png build/sprites.png tileset.h sprites.h
